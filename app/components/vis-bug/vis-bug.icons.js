...
export const facebook_pixel = `
  <svg viewBox="0 0 24 24">
    <path d="M21.6 0H2.4C1.08 0 0 1.08 0 2.4v19.2C0 22.92 1.08 24 2.4 24h10.37v-9.31H9.69v-3.63h3.09V8.36c0-3.06 1.87-4.73 4.6-4.73 1.31 0 2.44.1 2.77.14v3.21h-1.9c-1.49 0-1.78.71-1.78 1.75v2.3h3.55l-.46 3.63h-3.09V24H21.6c1.32 0 2.4-1.08 2.4-2.4V2.4C24 1.08 22.92 0 21.6 0z"/>
  </svg>
`
